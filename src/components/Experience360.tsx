    ...
    <>
      <div className="w-11/12  mx-auto flex justify-between my-12 text-black items-center">
        ...
        <div className="md:w-[50%] w-11/12 mx-auto md:mx-[unset] md:ml-[6rem]">
          ...
          <svg width="482" className="w-full md:w-[unset]" height="19" viewBox="0 0 482 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-[18px] text-[#382e2e] py-5">
          Where every angle tells a story, and every detail paints a picture of perfection.
          </p>

          <div className="flex py-4 items-center ">
            <a href={"https://justcall.io/calendar/DesignElementary"} className="text-black hover:text-black">
