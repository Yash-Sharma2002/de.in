    ...
    <>
      <div className="w-11/12 md:w-10/12 mx-auto py-8 text-black">
        ...
        <Text>
          ...
          use of Design Elementary's Website, located at{" "}
          <strong>
            <a
              href="https://www.DesignElementary.in"
              className="text-black hover:text-black"
            >
              {" "}
              https://www.DesignElementary.in
            </a>{" "}
          </strong>
          .
          <br />
          ...
          <strong> www.DesignElementary.in</strong> if you do not agree to take
          all of the terms and conditions stated on this page.
        </Text>
        <Head>Cookies</Head>
        <Text>
          The website uses cookies to help personalize your online experience.
          By accessing <strong> www.DesignElementary.in</strong> , you agreed to
        ...
        <Head>License:</Head>
        <Text>
          Unless otherwise stated, Design Elementary and/or its licensors own
          the intellectual property rights for all material on{" "}
          <strong> www.DesignElementary.in</strong> . All intellectual property
          rights are reserved. You may access this from{" "}
          <strong> www.DesignElementary.in</strong> for your own personal use
        ...
        <Text>
          ...
          <ol className="list-decimal list-inside">
            <li className="my-1">
              Copy or republish material from{" "}
              <strong> www.DesignElementary.in</strong>{" "}
            </li>
            <li className="my-1">
              {" "}
        ...
        <Text>
          ...
          opinions and information in certain areas of the website. Design
          Elementary does not filter, edit, publish or review Comments before
          their presence on the website. Comments do not reflect the views and
          opinions of Design Elementary, its agents, and/or affiliates. Comments
          reflect the views and opinions of the person who posts their views and
          opinions. To the extent permitted by applicable laws, Design
          Elementary shall not be liable for the Comments or any liability,
          ...
          <br />
          <br />
          Design Elementary reserves the right to monitor all Comments and
        ...
        <Text>
          You hereby grant Design Elementary a non-exclusive license to use,
        ...
        <Text>
          ...
          the hyperlink compensates the absence of Design Elementary; and (d)
          ...
          sending an e-mail to Design Elementary. Please include your name, your
        ...
        <Text>
          No use of Design Elementary's logo or other artwork will be allowed
          for linking absent a trademark license agreement.
        </Text>
        <Head>Content Liability:</Head>
        <Text>
        ...
        <Head>Reservation of Rights:</Head>
        <Text>
        ...
        <Head>Removal of links from our website:</Head>
        <Text>
