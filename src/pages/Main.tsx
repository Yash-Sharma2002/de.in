        ...
        <>
            ...
            <div className="py-14 ">
                ...
                <div className="flex justify-center md:justify-[unset] md:w-10/12 w-11/12 m-auto mt-4">
                    ...
                    <div>
                        <Steps
                            img={require("../assets/architecture/1.png").default}
                        ...
                        <Steps
                            img={require("../assets/architecture/2.png").default}
                            title="Explore Inspiring Designs"
                            description="Lorem ipsum dolor sit amet, consectetur adipisicing elit. At ad quibusdam id aspernatur quos."
                        />

                        <Steps
                            img={require("../assets/architecture/3.png").default}
                            title="Explore Inspiring Designs"
                            description="Lorem ipsum dolor sit amet, consectetur adipisicing elit. At ad quibusdam id aspernatur quos."
                        />

                        <Steps
                            img={require("../assets/architecture/4.png").default}
                            title="Explore Inspiring Designs"
                            description="Lorem ipsum dolor sit amet, consectetur adipisicing elit. At ad quibusdam id aspernatur quos."
                        />

                        <Steps
                            img={require("../assets/architecture/5.png").default}
                            title="Explore Inspiring Designs"
                            description="Lorem ipsum dolor sit amet, consectetur adipisicing elit. At ad quibusdam id aspernatur quos."
                        />
                    </div>
            ...
            <div className="border border-black py-4 md:py-10  bg-[#1B454D] relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-white">
                ...
                <div className="flex flex-col justify-center items-center">
                    <img
                        src={require("../assets/architecture/logo2.png").default}
            ...
            <div className="py-8 md:py-14 md:w-[80%] m-auto">
                ...
                <div className="flex justify-around items-center py-8">
                    <img
                        src={require("../assets/architecture/building1.png").default}
                        width={100}
                        height={100}
                        alt="building img"
                        className="w-[60%]"
                    />
                    <img
                        src={require("../assets/architecture/building2.png").default}
                        width={60}
                        height={60}
                        alt="building img"
