            ...
            <div className="py-14 ">
                ...
                <div className="flex justify-center md:justify-[unset] md:w-10/12 w-11/12 m-auto mt-4">
                    ...
                    <div>
                        ...
                        <Steps
                            img={<svg width="42" height="64" viewBox="0 0 42 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Steps
                            img={<svg width="42" height="65" viewBox="0 0 42 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Steps
                            img={<svg width="49" height="62" viewBox="0 0 49 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Steps
                            img={<svg width="43" height="64" viewBox="0 0 43 64" fill="none" xmlns="http://www.w3.org/2000/svg">
